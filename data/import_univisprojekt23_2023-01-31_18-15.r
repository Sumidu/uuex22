...
ds_file = "https://www.soscisurvey.de/univisprojekt23/?act=VLQ0Xg2eNGmhHNAO29yWBOGt"
...
ds = read.table(
  ...
  col.names = c(
    ...
    "UX02_08","TIME001","TIME002","TIME003","TIME004","TIME005","TIME_SUM",
  ...
  colClasses = c(
    ...
    UX02_07="numeric", UX02_08="numeric", TIME001="integer", TIME002="integer",
...
attr(ds, "project") = "univisprojekt23"
attr(ds, "description") = "UniVIs App 2023"
attr(ds, "date") = "2023-01-31 18:15:35"
...
comment(ds$TX03) = "Aufgabe 1 Result"
comment(ds$TX05) = "Aufgabe 2 Result"
